...
var
  ...
  P: TPessoa;
begin
  // Procura do último elemento do tipo TPessoaFisica na lista
  for i := Form1.ListaPessoas.Count - 1 downto 0 do
  begin
    P := TPessoa(Form1.ListaPessoas[i]);
    if P is TPessoaFisica then
    begin
      Form1.ListaPessoas.Delete(i); // Remove da lista principal
      P.Free; // Libera a memória
      Break;  // Sai do loop após remover o último
    end;
  end;
